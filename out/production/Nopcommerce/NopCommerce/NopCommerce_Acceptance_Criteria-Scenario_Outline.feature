Feature: Book category
  ...
  Scenario Outline: I should be able to choose any filter option with specific result
    ...
    Examples:
      ...
      | Sort by | Name:A to Z        | sorted product with the product name is alphabetical order A To Z |
      | Sort by | Name:Z to A        | sorted product with the product name is alphabetical order Z To A |
      ...
      | Sort by | 3                  | 3 Products in a page                                              |
      | Sort by | 6                  | 6 Products in a page                                              |
      | Sort by | 9                  | 9 Products in a page                                              |
